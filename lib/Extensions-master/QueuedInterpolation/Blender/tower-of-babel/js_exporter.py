        ...
        try:
            ...
            for object in [object for object in scene.objects]:
                ...
                if object.type == 'CAMERA':
                    ...
                    if object.data.meshOrHair == TREAT_AS_HAIR:
            ...
            # convenience members, for less argument passing to world
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    def to_script_file(self):
        ...
        # Materials - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        # if there are meshes, then need materials.  This check primarily for single Hair exports
        if self.needMaterials:
            file_handler.write('\n')
        ...
        if self.hasCameras:
            ...
            file_handler.write(indent2 + 'var camera;\n\n') # intentionally vague, since sub-classes instances & different specific properties set
        ...
        if self.hasShadows:
            ...
            file_handler.write(indent2 + 'var light;\n') # intentionally vague, since scene.getLightByID() returns Light, not DirectionalLight
